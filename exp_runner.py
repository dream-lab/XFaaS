...
exp1 = 'python3 serwo/xfaas_run_benchmark.py --csp azure --region centralindia --max-rps 1 --duration 300 --payload-size medium --dynamism static --wf-name graph --wf-user-directory /Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/graph_processing_wf --path-to-client-config /Users/varad.kulkarni/xfaas/XFaaS/serwo/config/client_config.json --dag-file-name dag.json --teardown-flag 0 --client-key azure-1'
...
exp1 = 'python3 serwo/xfaas_run_benchmark.py --csp azure --region centralindia --max-rps 1 --duration 300 --payload-size medium --dynamism static --wf-name math --wf-user-directory /Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/math_processing_wf --path-to-client-config /Users/varad.kulkarni/xfaas/XFaaS/serwo/config/client_config.json --dag-file-name dag.json --teardown-flag 0 --client-key azure-1'
...
exp1 = 'python3 serwo/xfaas_run_benchmark.py --csp azure --region centralindia --max-rps 1 --duration 300 --payload-size medium --dynamism static --wf-name image --wf-user-directory /Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/image_processing_wf --path-to-client-config /Users/varad.kulkarni/xfaas/XFaaS/serwo/config/client_config.json --dag-file-name dag.json --teardown-flag 0 --client-key azure-1'
...
exp1 = 'python3 serwo/xfaas_run_benchmark.py --csp azure --region centralindia --max-rps 1 --duration 300 --payload-size medium --dynamism static --wf-name text --wf-user-directory /Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/text_analytics_wf --path-to-client-config /Users/varad.kulkarni/xfaas/XFaaS/serwo/config/client_config.json --dag-file-name dag.json --teardown-flag 0 --client-key azure-1'
