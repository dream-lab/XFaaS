...
def generate_sfn_yaml(function_params: list, statemachine_params: dict, function_object_map: dict,template_dir:str, output_dir: str, yaml_file: str, trigger_type: TriggerType) -> None:
    ...
    try:
        ...
        raise AWSSfnYamlGeneratorExeception("KeyError: Invalid 'uri' key in statemachine parameters")
    ...
    try:
        ...
        print(f"Generated statemachine parameters.. TODO: - <print the parameters here>")
    except:
        raise AWSSfnYamlGeneratorExeception("KeyError: 'name' key in statemachine parameters")
    ...
    try:
        ...
        raise AWSSfnYamlGeneratorExeception("Error in loading jinja template environment")
    
    # render function
    try:
        output = template.render(serwouri=uri,
