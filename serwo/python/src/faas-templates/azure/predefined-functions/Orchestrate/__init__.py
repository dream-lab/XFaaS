...
def orchestrator_function(context: df.DurableOrchestrationContext):
    ...
    # user dag execution
    blam = yield context.call_activity("TaskA", serwoObject)
    vadl = yield context.call_activity("TaskB", blam)
    vadl = insert_end_stats_in_metadata(vadl)
    jrlj = yield context.call_activity("PushToSQS", vadl)
    return jrlj
