...
def generate_app_name_and_populate_and_get_ingress_queue_name(user_app_name,region,part_id,is_netherite):
    ...
    if not os.path.exists(resources_json):
        raise FileNotFoundError(f"Azure resources file not found: {resources_json}. This file should be generated by the resource generator. Check if the resource generation step failed.")
