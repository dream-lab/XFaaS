...
def plot_metrics(user_wf_dir, wf_deployment_id, run_id,csp,payload_size):
    # if (payload_size == 'large' and csp == 'aws') or (wf == 'image' and payload_size =='large'):
    #     god_list.append([])
    #     return
    format = 'pdf'
...
if __name__ == "__main__":
    ...
    # dirs = ['/Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/text_analytics_wf_aws','/Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/text_analytics_wf','/Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/text_analytics_wf']
    ...
    for d in data:
        ...
        plot_metrics(wf_user_directory,wf_deployment_id,run_id,csp,payload_size)
        i+=1


# labels = ['AWS 1','AZ 1','AZv2 1','AWS 4','AZ 4','AZv2 4','AWS 8','AZ 8','AZv2 8']
# labels = ['AWS SM','AZ SM','AZv2 SM','AWS ME','AZ ME','AZv2 ME','AWS LA','AZ LA','AZv2 LA']
...
# ax.legend(handles=[orange_patch,blue_patch,green_patch],loc='upper left',fontsize=fontdict['size'])
format = 'pdf'

fig.savefig(f'netherite_cache.{format}',bbox_inches='tight')
