...
def plot_text(wf, dynamism, colors, large_x, large_y, large_y2):
    ...
    plt.savefig(f"other_wfs_scaling_plot/text_step_{wf}.pdf", bbox_inches='tight')
...
def plot_image(wf, dynamism, colors, medium_x, medium_y, medium_y2):
    ...
    ax3.plot(small_x[0],OVERLAYS[0],color='red',zorder=6)
    plt.savefig(f"other_wfs_scaling_plot/image_step_{wf}.pdf", bbox_inches='tight')
...
def plot_math(wf, dynamism, colors, small_x, small_y, small_y2, aws_legend, az_legend, azv2_legend):
    ...
    plt.savefig(f"other_wfs_scaling_plot/math_step_{wf}.pdf", bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    i = 0
    dirs = ['/Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/math_processing_wf','/Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/image_processing_wf','/Users/varad.kulkarni/xfaas/xfaas-workloads/workflows/custom_workflows/text_analytics_wf']
    for d in data:
...
e23d91e9-0c7d-4866-8a16-ed312fce3613,aws,centralindia,8,300,medium,step_up
2537e869-9838-4a6b-aee7-e6295c2a8663,aws,centralindia,8,300,medium,step_up
60f4315f-705f-44cd-b199-cad5b387ac6e,aws,centralindia,8,300,medium,step_up
c6b7fee7-9cc8-4efa-a74c-52e5c3d43eac,azure,centralindia,8,300,medium,step_up
dec9cc2f-7617-48e2-9525-54ddce249575,azure,centralindia,8,300,medium,step_up
5271f0c9-8ff7-4f39-8ba8-d1adbd512c33,azure,centralindia,8,300,medium,static
00a4f7be-8ab9-4a23-b7e6-fbc89af0b1d7,azure_v2,centralindia,8,300,medium,step_up
48fdf7bc-ec8f-4a73-b5e3-3f101bdeaaf5,azure_v2,centralindia,8,300,medium,step_up
dd19055d-1495-4afb-b94e-05cc3639e37f,azure_v2,centralindia,8,300,medium,step_up
