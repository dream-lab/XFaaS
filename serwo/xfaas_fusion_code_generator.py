...
def generate(G, fc, user_og_graph, suffix_str, user_dir, dag_definition_path):
    ...
    start_key = 'Start'
    end_key = 'End'
    pth,pp,fin_graph = generate_fused_code(G, end_key, k, start_key, user_og_graph,suffix_str,final_edges,user_dir,
                                           dag_definition_path)
...
def generate_fused_code(G, end_key, k, start_key, user_og_graph,suffix_str,final_edges,user_dir,dag_definition_path):
    ...
    pp = create_dag_description(get_app_name(dag_definition_path), deep_fin,CSP.toCSP("AWS"),user_dir,suffix_str)
